export const idlFactory = ({ IDL }) => {
  ...
  const Message = IDL.Record({
    ...
    edited: IDL.Bool,
    tips: IDL.Vec(IDL.Tuple(CanisterId, IDL.Vec(IDL.Tuple(UserId, IDL.Nat)))),
    sender: UserId,
  ...
  return IDL.Service({
    accept_p2p_swap: IDL.Func([AcceptP2PSwapArgs], [AcceptP2PSwapResponse], []),
    ...
    cancel_p2p_swap: IDL.Func([CancelP2PSwapArgs], [CancelP2PSwapResponse], []),
    ...
    create_channel: IDL.Func([CreateChannelArgs], [CreateChannelResponse], []),
    ...
    delete_channel: IDL.Func([DeleteChannelArgs], [DeleteChannelResponse], []),
    ...
    disable_invite_code: IDL.Func([EmptyArgs], [DisableInviteCodeResponse], []),
    edit_message: IDL.Func([EditMessageArgs], [EditMessageResponse], []),
    enable_invite_code: IDL.Func([EmptyArgs], [EnableInviteCodeResponse], []),
    ...
    join_video_call: IDL.Func([JoinVideoCallArgs], [JoinVideoCallResponse], []),
    ...
    report_message: IDL.Func([ReportMessageArgs], [ReportMessageResponse], []),
    ...
    update_channel: IDL.Func([UpdateChannelArgs], [UpdateChannelResponse], []),
